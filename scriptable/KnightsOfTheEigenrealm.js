...
const SETTINGS = {
  ...
  /* The Wilds: open country, walked rather than descended, and the first place
     ...
     Like the Tavern and the Summit it pays no material, for the same stated
     reason: what is learned out here is Tracking and Beast taming — Foresight
     and Passage. Herbalism is the Wilds' Material skill and is not built; it
     wants a gathering room and a use for what it gathers, which is its own
     slice rather than something bolted onto this one. */
  wilds: {
